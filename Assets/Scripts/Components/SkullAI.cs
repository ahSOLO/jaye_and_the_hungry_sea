...
public class SkullAI : MonoBehaviour
{
    ...
    public void SkullHit()
    {
        ...
        {
            case 0:
                transform.position = new Vector3(player.transform.position.x - 40f, player.transform.position.y, transform.position.z);
                break;
            case 1:
                transform.position = new Vector3(player.transform.position.x + 40f, player.transform.position.y, transform.position.z);
                break;
            case 2: 
                transform.position = new Vector3(player.transform.position.x - 25f, player.transform.position.y - 30f, transform.position.z);
                break;
            case 3:
                transform.position = new Vector3(player.transform.position.x + 25f, player.transform.position.y - 30f, transform.position.z);
                break;
